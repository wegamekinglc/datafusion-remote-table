...
+-------------------------------------------------+-------------------------------------------------+-------------------------------------------------+-------------------------------------------------+----------------------------------------------------+----------------------------------------------------+----------------------------------------------------+-------------------------------------------------+-----------------------------------------------------+----------------------------------------------------+----------------------------------------------------------+--------------------------------------------------+-------------------------------------------------------+---------------------------------------------------+---------------------------------------------------+---------------------------------------------------+---------------------------------------------------+---------------------------------------------------+
| transform_int64-0-Int64-Sqlite(Integer)-Some(1) | transform_int64-1-Int64-Sqlite(Integer)-Some(2) | transform_int64-2-Int64-Sqlite(Integer)-Some(3) | transform_int64-3-Int64-Sqlite(Integer)-Some(4) | transform_float64-4-Float64-Sqlite(Real)-Some(1.1) | transform_float64-5-Float64-Sqlite(Real)-Some(2.2) | transform_float64-6-Float64-Sqlite(Real)-Some(3.3) | transform_utf8-7-Utf8-Sqlite(Text)-Some("char") | transform_utf8-8-Utf8-Sqlite(Text)-Some("char(10)") | transform_utf8-9-Utf8-Sqlite(Text)-Some("varchar") | transform_utf8-10-Utf8-Sqlite(Text)-Some("varchar(120)") | transform_utf8-11-Utf8-Sqlite(Text)-Some("text") | transform_utf8-12-Utf8-Sqlite(Text)-Some("text(200)") | transform_binary-13-Binary-Sqlite(Blob)-Some([1]) | transform_binary-14-Binary-Sqlite(Blob)-Some([2]) | transform_binary-15-Binary-Sqlite(Blob)-Some([3]) | transform_binary-16-Binary-Sqlite(Blob)-Some([4]) | transform_binary-17-Binary-Sqlite(Blob)-Some([5]) |
| transform_int64-0-Int64-Sqlite(Integer)-None    | transform_int64-1-Int64-Sqlite(Integer)-None    | transform_int64-2-Int64-Sqlite(Integer)-None    | transform_int64-3-Int64-Sqlite(Integer)-None    | transform_float64-4-Float64-Sqlite(Real)-None      | transform_float64-5-Float64-Sqlite(Real)-None      | transform_float64-6-Float64-Sqlite(Real)-None      | transform_utf8-7-Utf8-Sqlite(Text)-None         | transform_utf8-8-Utf8-Sqlite(Text)-None             | transform_utf8-9-Utf8-Sqlite(Text)-None            | transform_utf8-10-Utf8-Sqlite(Text)-None                 | transform_utf8-11-Utf8-Sqlite(Text)-None         | transform_utf8-12-Utf8-Sqlite(Text)-None              | transform_binary-13-Binary-Sqlite(Blob)-None      | transform_binary-14-Binary-Sqlite(Blob)-None      | transform_binary-15-Binary-Sqlite(Blob)-None      | transform_binary-16-Binary-Sqlite(Blob)-None      | transform_binary-17-Binary-Sqlite(Blob)-None      |
+-------------------------------------------------+-------------------------------------------------+-------------------------------------------------+-------------------------------------------------+----------------------------------------------------+----------------------------------------------------+----------------------------------------------------+-------------------------------------------------+-----------------------------------------------------+----------------------------------------------------+----------------------------------------------------------+--------------------------------------------------+-------------------------------------------------------+---------------------------------------------------+---------------------------------------------------+---------------------------------------------------+---------------------------------------------------+---------------------------------------------------+"#,
    );
}
