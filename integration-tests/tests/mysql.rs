...
pub async fn supported_mysql_types() {
    ...
    assert_eq!(
        ...
        "+-------------+--------------+-------------+------------+-----------+------------+----------+-------------+--------------+----------+----------------+--------------+----------+----------------+
| tinyint_col | smallint_col | integer_col | bigint_col | float_col | double_col | char_col | varchar_col | tinytext_col | text_col | mediumtext_col | tinyblob_col | blob_col | mediumblob_col |
+-------------+--------------+-------------+------------+-----------+------------+----------+-------------+--------------+----------+----------------+--------------+----------+----------------+
| 1           | 2            | 3           | 4          | 1.1       | 2.2        | char     | varchar     | tinytext     | text     | mediumtext     | 01           | 02       | 03             |
|             |              |             |            |           |            |          |             |              |          |                |              |          |                |
+-------------+--------------+-------------+------------+-----------+------------+----------+-------------+--------------+----------+----------------+--------------+----------+----------------+"
    )
}
